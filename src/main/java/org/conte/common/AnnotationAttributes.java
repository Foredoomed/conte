 ...
 * {@link org.springframework.core.type.AnnotationMetadata AnnotationMetadata}
 * implementations. Provides 'pseudo-reification' to avoid noisy Map generics in
 * the calling code as well as convenience methods for looking up annotation
 * attributes in a type-safe fashion.
 * 
 * @author Chris Beams
 * @since 3.1.1
 */
...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
	 ...
	 * 
	 * @param map
	 *            original source of annotation attribute key/value pairs to
	 *            wrap
	 * @see #fromMap(Map)
	 */
	 ...
	 * if the map is already an {@code AnnotationAttributes} instance, it is
	 * casted and returned immediately without creating any new instance;
	 * otherwise create a new instance by wrapping the map with the
